...
<head>
  ...
  <title>Globuscup 2016</title>
    ...
    <meta property="author" content="Simone Corsi">
    <link rel="canonical" href="http://www.globuscup.it">
    ...
    <meta property="og:image"              content="{{ $news->featured ? $news->featured->path . '?v=1' :'http://www.globuscup.it/images/globus_facebook.jpg' }}" />
